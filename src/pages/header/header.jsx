        ...
        <div className="flex items-center justify-between py-4">
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="Languages flex gap-3">
             <button className="flex items-center gap-2 px-3 py-2 hover:bg-gray-50 rounded-lg transition-colors" >uz</button>
             <button className="flex items-center gap-2 px-3 py-2 hover:bg-gray-50 rounded-lg transition-colors" >ru</button>
             <button className="flex items-center gap-2 px-3 py-2 hover:bg-gray-50 rounded-lg transition-colors" >eng</button>
            </div>
            <button className="flex items-center gap-2 px-3 py-2 hover:bg-gray-50 rounded-lg transition-colors relative">
              ...
              <span className="text-sm">Saralangan</span>
            </button>
            <NavLink
              to="/cart"
        ...
        <div className="flex items-center gap-6 py-2 overflow-x-auto">
            ...
            >
              <img
                ...
                className="h-6"
              />
              <span className="font-medium">Hafta tovarlari</span>
            </a>
            <a
              href="#"
              className="flex items-center gap-2 text-xs whitespace-nowrap hover:text-purple-600 py-1"
            ...
            <a
              ...
              className="flex items-center gap-2 text-xs whitespace-nowrap hover:text-purple-600 py-1"
            >
              <span>Turizm, balig'ovi va ovchilik</span>
            </a>
            <a
              href="#"
              className="flex items-center gap-2 text-xs whitespace-nowrap hover:text-purple-600 py-1"
