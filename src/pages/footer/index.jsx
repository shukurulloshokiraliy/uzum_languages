    ...
    <footer className="bg-gray-50 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-gray-900 mb-4">{t('aboutUs')}</h3>
          ...
          <div>
            <h3 className="font-bold text-gray-900 mb-4">{t('forUsers')}</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-600 hover:text-purple-600 text-sm">
                  {t('contactUs')}
          ...
          <div>
            <h3 className="font-bold text-gray-900 mb-4">{t('forEntrepreneurs')}</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-600 hover:text-purple-600 text-sm">
                  {t('sellOnUzum')}
          ...
          <div>
            <h3 className="font-bold text-gray-900 mb-4">{t('getApp')}</h3>
            <div className="space-y-3">
              ...
              <div className="mt-6">
                <h4 className="font-bold text-gray-900 mb-3">{t('uzumSocialMedia')}</h4>
